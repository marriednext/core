...
export default function NavBar() {
  return (
    <nav className="w-full fixed top-0 left-0 z-20">
      <div className="max-w-3xl mx-auto px-6 py-3 flex items-center justify-center gap-6 bg-white/70 backdrop-blur-md border-b border-white/40 rounded-b-2xl shadow-lg">
        <Link
          href="/"
