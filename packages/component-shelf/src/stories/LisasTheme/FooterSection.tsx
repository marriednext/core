...
export function FooterSection({ nameA, nameB, eventDate, location }: FooterSectionProps) {
  ...
  return (
    <footer className="py-20 bg-[#2c2c2c] text-white/80">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <h2 className="font-serif text-4xl md:text-5xl text-white font-light italic mb-8">{coupleName}</h2>
        ...
        {nameA && nameB && (
          <p className="text-white/40 text-sm">#{nameA}And{nameB}{eventDate ? new Date(eventDate).getFullYear() : ""}</p>
        )}
