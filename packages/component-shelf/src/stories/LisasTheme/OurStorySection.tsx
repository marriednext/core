...
export function OurStorySection({ nameA, nameB, imageUrl, imageComponent }: OurStorySectionProps) {
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
          <div className="aspect-[4/5] overflow-hidden">
            {imageComponent || (
              <img src={imageUrl || "/romantic-couple-engagement-photo-in-nature-golden-.jpg"} alt={coupleName} className="w-full h-full object-cover" />
            )}
          </div>
          <div className="space-y-8">
            ...
            <p className="text-lg text-[#2c2c2c]/70 leading-relaxed">
              From that first meeting, we knew there was something different—something worth holding onto. We're ready to make it official, surrounded by the people who matter most to us.
            </p>
          </div>
        </div>
