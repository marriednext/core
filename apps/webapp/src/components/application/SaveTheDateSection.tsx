...
export function SaveTheDateSection() {
  ...
  const attendingCount =
    ...
    guests.filter((g) => g.isAttending && g.hasPlusOne && g.plusOneAttending)
      .length;
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              This is an interactive demo of the actual RSVP form your guests
              will use. Try it out — respond for multiple guests, add plus ones,
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Start the interactive RSVP experience
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-medium text-foreground">
                    Respond for each guest
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Just like a real invitation with multiple guests
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    If attending, you can bring a guest
                  </p>
                </div>
              </div>
            </div>
            ...
            <p className="text-sm text-muted-foreground italic">
              Don't worry — this is just a demo. You're not actually RSVPing to
              anything!
            </p>
          </div>
                ...
                {demoStep === "intro" && (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-muted-foreground mb-8">
                      Someday, 2025 • A Beautiful Venue
                    </p>
                      ...
                      <div key={guest.id} className="space-y-4">
                        ...
                        <div className="flex gap-2">
                          <Button
                            type="button"
                            variant={
                              guest.isAttending === true ? "default" : "outline"
                            }
                            size="sm"
                            className="flex-1"
                            onClick={() =>
                              handleGuestResponse(guest.id, "isAttending", true)
                            }
                          >
                ...
                {demoStep === "success" && (
                  <div className="text-center py-8">
                    ...
                    <p className="text-xs text-muted-foreground mb-6">
                      This was just a demo — no real RSVP was sent!
                    </p>
